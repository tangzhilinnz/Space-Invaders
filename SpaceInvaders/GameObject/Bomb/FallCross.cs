...
namespace SE456
{
    class FallCross : FallStrategy
    {
        public FallCross()
        {
            ...
            // Get the image
            Image pImage_A = ImageMan.Find(Image.Name.BombCross_A);
            Image pImage_B = ImageMan.Find(Image.Name.BombCross_B);
            Image pImage_C = ImageMan.Find(Image.Name.BombCross_C);
            Image pImage_D = ImageMan.Find(Image.Name.BombCross_D);
