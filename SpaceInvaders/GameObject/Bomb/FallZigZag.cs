...
namespace SE456
{
    class FallZigZag : FallStrategy
    {
        public FallZigZag()
        {
            ...
            // Get the image
            Image pImage_A = ImageMan.Find(Image.Name.BombZigZag_A);
            Image pImage_B = ImageMan.Find(Image.Name.BombZigZag_B);
            Image pImage_C = ImageMan.Find(Image.Name.BombZigZag_C);
            Image pImage_D = ImageMan.Find(Image.Name.BombZigZag_D);
